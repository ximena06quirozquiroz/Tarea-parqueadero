...
* `python/`: Servidor de sockets TCP, puente de comunicación (`ctypes`) y el módulo `visualizador.py` con el diseño de la interfaz gráfica.

---
**Desarrollado por:** XIMENA & CAMILA  
